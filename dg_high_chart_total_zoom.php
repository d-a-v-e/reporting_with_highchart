...
<?php 
    ...
    $url = "http://www.biota-labs.com/ei/sales/ei_return_sales_total.php?";
?>
<!-- Page content -->
<div id="page-content">
    <!-- Blank Header -->
    ...
    <div class="block full">
        <div class="block-title">
            <h2><strong>Sales</strong> by outlet</h2>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="block-section">
                <h4 class="sub-header">List of Outlets</h4>
                    <div class="table-responsive">
                        <table id="general-table" class="table table-striped table-vcenter">
                            ...
                            <tbody>
                                ...
                                <?php
                                $fullUrl = $url.'clientid='.$clientid.'&campaignid='.$campaignid;
                                ...
                                $source = $value["source"];
                                $variablesToPass = '1,30,'.$source;        
                                    echo '<tr>
                                    <td>'.$value["outlet"].'</td>
                                    <td>'.$value["volume"].'</td>
                                    <td>£'.$value["value"].'</td>

                                    <td><button type="button" class="btn btn-sm btn-success" onclick="PieChart.init('.$variablesToPass.');">View</button></a></td>
                                    </tr>';    
                                }
                                ?>  
                            </tbody>
            ...
            <div class="col-md-8">
                <div class="block-section">
                    <div id="pie-container" class="chart"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="block full">
        <div class="block-title">
            ...
            <div id="map-canvas" style="height: 500px; margin: 0px; padding-bottom: 0px"></div>
    </div>
    <!-- END HeatMap -->
</div>
<!-- END Page Content -->
...
<script src="js/dgjs/dg_highChart.js"></script>
<script src="js/dgjs/dg_highChartPie.js"></script>
<script>$(function(){ PieChart.init(1,30,0); });</script>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=visualization"></script>
<script>
// Adding 500 Data Points
var map, pointarray, heatmap;
console.log("hello there, this is the google maps bit!");
var taxiData = [
